...
def test_return_td_inday_quinze_janeiro_2020():
    ...
    assert td_inday_quinze_janeiro_2020 == '☉ in 25º ♑ ☽ in 05º ♎ Dies Mercurii Anno 116 æræ novæ'


def test_return_td_inday_oito_abril_1905():
    td_inday_onze_abril_1905 = thelemicdate.in_day(1905, 4, 8, 12, 30)
    assert td_inday_onze_abril_1905 == '☉ in 18º ♈ ☽ in 28º ♉ Dies Saturnii Anno 1 æræ novæ'
